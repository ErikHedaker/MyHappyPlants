...
public class PlantPanel extends JPanel {
    ...
    public PlantPanel(Plant plant) {
        ...
        JLabel label1 = new JLabel(Utilities.centerText("Previous: " + plant.getDays_ago() + "d ago", 0)
                + "                     Next: " + plant.getDaysLeft() + " days left");
    ...
    class Inner extends Thread {
        ...
        public void run() {
            while (true) {
                int daysLeft = plant.getDaysLeft();
                if (x > ((daysLeft) * (plant.getDaysWithoutWater() == 0 ? 20 : plant.getDaysWithoutWater())))
                    x--;
